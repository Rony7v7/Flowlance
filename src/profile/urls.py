...
urlpatterns = [
    ...
    path('', profile_views.my_profile, name='freelancer_profile'), # TODO: URL for viewing the own profile - name debería ser 'my_profile' y por lo tanto ser actualizado en donde se llame
    path('freelancer_profile/<str:username>/', profile_views.my_profile, name='freelancer_profile_view'),  # URL for viewing another freelancer profile
